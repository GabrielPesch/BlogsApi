...
//     it('Deve disparar um erro se authorizationMiddleware.validate disparar um erro', () => {
//       sinon.stub(authorizationMiddleware, 'validate').rejects();
//       return chai.expect(postsController.search({}, {})).to.eventually.be.rejected;
//     });

//     it('Deve disparar um erro se uma query for passada e postsService.findByQuery disparar um erro', () => {
//       sinon.stub(authorizationMiddleware, 'validate').resolves();
//       sinon.stub(postsService, 'findByQuery').rejects();
//       return chai.expect(postsController.getById({query: 'q'}, {})).to.eventually.be.rejected;
//     });

//     it('Deve disparar um erro se uma query não for passada e postsService.getAll disparar um erro', () => {
//       sinon.stub(authorizationMiddleware, 'validate').resolves();
//       sinon.stub(postsService, 'getAll').rejects();
//       return chai.expect(postsController.getById({query: ''}, {})).to.eventually.be.rejected;
//     });
    
//     it('Deve retornar todos os posts se nenhuma query for passada', async () => {
//       sinon.stub(authorizationMiddleware, 'validate').resolves();
//       sinon.stub(postsService, 'getAll').resolves([]);
//       const res = makeRes();
//       await postsController.search({headers: {authorization: ''}, query: ''}, res);
//       return chai.expect(res.json.getCall(0).args[0]).to.deep.equal([]);
//     });

//     it('Deve retornar todos os posts que contenham a Query se esta for passada', async () => {
//       sinon.stub(authorizationMiddleware, 'validate').resolves();
//       sinon.stub(postsService, 'getAll').resolves([{}, {}]);
//       const res = makeRes();
//       await postsController.search({headers: {authorization: ''}, query: 'q'}, res);
//       return chai.expect(res.json.getCall(0).args[0]).to.deep.equal([{}, {}]);
//     });
//   });
// });